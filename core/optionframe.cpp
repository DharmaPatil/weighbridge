	...
	, m_workbench(wb)
{
    ...
    QTreeWidgetItem *category = addItem(tr("系统配置"));
    ...
    category = addItem(tr("系统参数"));
    addItem(new GeneralParamWidget(workbench()), category);
    addItem(new GainParamWidget(workbench()), category);
//	addItem(new DataCheckPage(workbench()), category);

//	addItem(new ReagentInfo(workbench()));
